...
export default function TrustedBy() {
	const logos = [
		...
		>
			...
			<text x='50' y='25' fill='#ffffff' fontSize='12' fontWeight='700'>
				Uni A
			</text>
		</svg>,
		<svg
		...
		>
			...
			<text x='44' y='25' fill='#ffffff' fontSize='12' fontWeight='700'>
				College B
			</text>
		</svg>,
		<svg
		...
		>
			...
			<text x='62' y='25' fill='#ffffff' fontSize='12' fontWeight='700'>
				Institute C
			</text>
		</svg>,
		<svg
		...
		>
			...
			<text x='48' y='25' fill='#ffffff' fontSize='12' fontWeight='700'>
				Org D
			</text>
		</svg>,
		<svg
		...
		>
			...
			<text x='56' y='25' fill='#ffffff' fontSize='12' fontWeight='700'>
				Corp E
			</text>
		</svg>,
		<svg
	...
	return (
		<section className='mx-auto w-full max-w-4xl py-12 text-center'>
			<h3 className='text-sm font-semibold text-purple-200/90'>
				Trusted by leading institutions
			</h3>
			<p className='mt-2 text-xs text-purple-100/70'>
				Institutions worldwide rely on ProctoAI for secure exams.
			</p>
